...
public class Main {
    ...
    private static void printFunc(int id) {
        int i = findFunc(id);
        if (i != -1) {
    ...
    private static int findFunc(int id) {
        int i;
        for (i = 0; i < folha.ListaFuncionarios.size(); i++) {
    ...
    private static Funcionario delFuncionario() {
        ListarFuncionarios();
    ...
    private static void lancarPonto() {
    ...
    private static void lancarVenda() {
    ...
    private static void lancarTaxas() {
    ...
    private static void agendaPagamento() {
    ...
    private static void menu() {
        ...
        if (folha.dia < 32) {
            ...
            } else if (option == 11) printFunc(exc.loadint());
